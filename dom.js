...
googleLogo.style.background = 'url(http://upload.wikimedia.org/wikipedia/commons/9/94/Yahoo-logo.jpg) no-repeat';
googleLogo.style.backgroundSize = '50%';

var googleSearchButton = document.getElementById('gbqfsa');
googleSearchButton.innerText = 'Yahoo!';
